...
<esdl:EnergySystem xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:esdl="http://www.tno.nl/esdl" version="6" id="5d539f68-f98e-466b-9ff5-b908a211e0ab_with_return_network_with_return_network" name="sourcesink with return network with return network" description="" esdlVersion="v2401">
  <instance xsi:type="esdl:Instance" name="Untitled instance" id="90e7e098-038e-4462-89fe-a8852c501753">
    <area xsi:type="esdl:Area" id="4fd1adc2-5371-4ab7-806a-b40e49d127e9" name="Untitled area">
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe1_ret" outerDiameter="0.45" id="Pipe1" length="1000.0" diameter="DN300" innerDiameter="0.15" name="Pipe1">
        ...
        <port xsi:type="esdl:InPort" connectedTo="8c166244-4529-4cb9-82d6-75235ef3c607" id="3b5636b1-7b14-46bd-bb27-c0718350b418" carrier="435a0034-fab0-4e7e-9a17-edf8de9a2b11" name="In"/>
      ...
      <asset xsi:type="esdl:Pipe" related="Pipe1" outerDiameter="0.45" id="Pipe1_ret" length="1000.0" diameter="DN300" innerDiameter="0.15" name="Pipe1_ret">
        ...
        <port xsi:type="esdl:OutPort" id="0f11bb2d-fb28-4f9d-8992-8d5901f579d7" carrier="435a0034-fab0-4e7e-9a17-edf8de9a2b11_ret" connectedTo="af3bd758-cc86-406f-ba52-d65ce1f00e74" name="Out_ret"/>
      ...
      <asset xsi:type="esdl:ElectricityCable" length="423.0" capacity="10000000.0" id="ce45d623-9749-42d2-b6e0-de0f09d1884b" name="ElectricityCable_ce45">
        ...
        <port xsi:type="esdl:OutPort" id="8303c87a-d294-4504-b8b9-17696494ebf3" carrier="0e237e2a-00d1-4c6c-b966-9c9b8d9657f8" connectedTo="a8ccfce0-0096-4c3a-937b-dac44b498f44" name="Out"/>
        <geometry xsi:type="esdl:Line" CRS="WGS84">
      ...
      <asset xsi:type="esdl:HeatPump" id="d8fdac8b-ac07-4d2d-a339-e84fb82dca17" power="10000000.0" name="HeatPump_d8fd" COP="4.0">
        <port xsi:type="esdl:InPort" connectedTo="0f11bb2d-fb28-4f9d-8992-8d5901f579d7" id="af3bd758-cc86-406f-ba52-d65ce1f00e74" carrier="435a0034-fab0-4e7e-9a17-edf8de9a2b11_ret" name="SecIn"/>
        <port xsi:type="esdl:OutPort" id="8c166244-4529-4cb9-82d6-75235ef3c607" carrier="435a0034-fab0-4e7e-9a17-edf8de9a2b11" connectedTo="3b5636b1-7b14-46bd-bb27-c0718350b418" name="SecOut"/>
        <port xsi:type="esdl:InPort" connectedTo="8303c87a-d294-4504-b8b9-17696494ebf3" id="a8ccfce0-0096-4c3a-937b-dac44b498f44" carrier="0e237e2a-00d1-4c6c-b966-9c9b8d9657f8" name="ElecPort"/>
